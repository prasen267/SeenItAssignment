...
import com.pb.seenItAssignment.data.api.NetworkConnectionInterceptor
import com.pb.seenItAssignment.data.api.TheNewService
import com.pb.seenItAssignment.data.repository.TheNewsRepository
import com.pb.seenItAssignment.ui.MainActivityViewModel
...
class seenItAssignment:Application(), KodeinAware {
    override val kodein= Kodein.lazy {
        ...
        bind()from singleton { TheNewService(instance()) }
